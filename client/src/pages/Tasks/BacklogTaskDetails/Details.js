...
import { addNewSubTask, deleteSubTask, getBacklogTaskDetail, getSubTaskList, updateSubTask } from '../../../store/actions';
import { getAllLabel, getLabelList, getLabelListByTask, getLabelListByTaskForDetails } from '../../../store/labels/action';
...
const Details = () => {
    ...
    if (backlogTaskDetail) {
        var labelFromTask = backlogTaskDetail.labelID.toString();
...
//>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    useEffect(() => {
        dispatch(getBacklogTaskDetail(taskId));
    }, [dispatch]);
                                ...
                                <Col className="ms-5" lg={7}>
                                    <Form onSubmit={handleSubmit}>
                                        ...
                                        <Row>
                                            ...
                                            <Col lg={3}>
                                                <button className="btn btn-soft-info" type='submit'>Add Subtasks</button>
                                            </Col>
                                        </Row>
                                        </FormGroup>
                                    </Form>
