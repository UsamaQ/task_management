...
function* onUpdateSubTask({ payload: subTask, checkedValue: checkedValue }) {
    console.log(checkedValue)
    try {
        const response = yield call(axios.post, 'http://localhost:3001/subTasks/update/subTask', {subTask, checkedValue});
