...
export const GET_TASK_LIST_ON_GLOBAL_SEARCH = "GET_TASK_LIST_ON_GLOBAL_SEARCH";
...
export const UPDATE_TASK_BY_SPRINTID = "UPDATE_TASK_BY_SPRINTID";
export const UPDATE_TASK_BY_SPRINTID_SUCCESS = "UPDATE_TASK_BY_SPRINTID_SUCCESS";
export const UPDATE_TASK_BY_SPRINTID_FAIL = "UPDATE_TASK_BY_SPRINTID_FAIL";
