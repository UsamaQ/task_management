...
const Login = (props) => {
    document.title="SignIn | Task Management";
                    ...
                    <Container>
                        <Row>
                            <Col lg={12}>
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    ...
                                    <p className="mt-3 fs-15 fw-medium">Best Admin Tool</p>
                                </div>
                            </Col>
                        </Row>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                ...
                                <div className="mt-4 text-center">
                                    <p className="mb-0">Don't have an account ?<Link to="/register" className="fw-semibold text-primary text-decoration-underline"> Register </Link> </p>
                                </div>
