...
import { Col, Modal, ModalBody, Row, Label, Input, Button, ModalHeader, FormFeedback, Form, Collapse, UncontrolledPopover, PopoverHeader, PopoverBody } from 'reactstrap';
...
const AllSprints = () => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      status: (sprint && sprint.status) || 'New',
      priority: (sprint && sprint.priority) || 'High',
    },
  ...
  useEffect(() => {
    if (!isEmpty(sprintList)) setSprintList(sprintList);
  }, [sprintList]);
          ...
          <div className="card" id="tasksList">
                ...
                <div className="row g-3">
                  <div className="col-xxl-5 col-sm-12">
                    <div className="search-box">
                      <input type="text" className="form-control search bg-light border-light" placeholder="Search for sprints ..." />
            ...
            <div className="card-body">
              <TableContainer
                ...
                handleSprintClick={handleSprintClicks}
